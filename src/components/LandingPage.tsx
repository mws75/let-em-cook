  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-bg">
      ...
      <div className="text-center mb-6">
        <h1 className="text-3xl sm:text-5xl font-bold text-text mb-2">Let Em Cook</h1>
      ...
      <div className="w-full max-w-2xl bg-surface border-2 border-border rounded-3xl p-5 sm:p-8 mb-5 shadow-lg">
        {/* Step 1 */}
        <div className="flex items-center gap-5 mb-6">
          ...
          <h2 className="text-lg sm:text-2xl font-bold text-text">Add Recipes</h2>
        </div>
        ...
        <div className="flex items-center gap-5 mb-6">
          ...
          <h2 className="text-lg sm:text-2xl font-bold text-text">Create Meal Plan</h2>
        </div>
      ...
      <SignUpButton mode="modal">
        <button className="w-full max-w-2xl bg-accent hover:bg-accent/80 border-2 border-border rounded-3xl py-4 mb-3 shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all">
          <span className="text-xl sm:text-2xl font-bold text-text">Sign Up</span>
        </button>
      </SignUpButton>
